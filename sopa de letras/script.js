...
async function generateWordDoc() {
    ...
    try {
        ...
        if (finalZip.files[documentFile]) {
            ...
            const contentXML = generateContentXML(students, searchWords, displayWords, currentDiff, seed);
...
function generateContentXML(students, searchWords, displayWords, difficulty, baseSeed) {
    let contentXML = '';
